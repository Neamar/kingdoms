...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AvatarCategory.slug'
        db.add_column('internal_avatarcategory', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='slug', unique=True, max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AvatarCategory.slug'
        db.delete_column('internal_avatarcategory', 'slug')
