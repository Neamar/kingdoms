...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Freeze'
        db.create_table('internal_freeze', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('kingdom', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['kingdom.Kingdom'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('datas', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal('internal', ['Freeze'])


    def backwards(self, orm):
        # Deleting model 'Freeze'
        db.delete_table('internal_freeze')
