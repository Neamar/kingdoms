...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Recurring', fields ['slug']
        db.create_unique(u'internal_recurring', ['slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Recurring', fields ['slug']
        db.delete_unique(u'internal_recurring', ['slug'])
