...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ScriptLog.kingdom'
        db.add_column(u'internal_scriptlog', 'kingdom',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['kingdom.Kingdom'], null=True, on_delete=models.SET_NULL),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ScriptLog.kingdom'
        db.delete_column(u'internal_scriptlog', 'kingdom_id')
