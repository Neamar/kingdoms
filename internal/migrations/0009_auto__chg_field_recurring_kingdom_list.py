...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Recurring.kingdom_list'
        db.alter_column(u'internal_recurring', 'kingdom_list', self.gf('config.fields.script_field.ScriptField')(null=True))

    def backwards(self, orm):

        # Changing field 'Recurring.kingdom_list'
        db.alter_column(u'internal_recurring', 'kingdom_list', self.gf('config.fields.script_field.ScriptField')())
    ...
    models = {
        ...
        u'internal.recurring': {
            ...
            'description': ('django.db.models.fields.TextField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'kingdom_list': ('config.fields.script_field.ScriptField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '255'}),
