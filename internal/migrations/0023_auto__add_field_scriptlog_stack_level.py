...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ScriptLog.stack_level'
        db.add_column('internal_scriptlog', 'stack_level',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ScriptLog.stack_level'
        db.delete_column('internal_scriptlog', 'stack_level')
