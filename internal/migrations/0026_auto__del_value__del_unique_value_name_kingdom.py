...
class Migration(SchemaMigration):
    # This migrations moves a table from one app to another,
    # This one is empty, the real stuff is in kingdom/0018_auto__add_value__add_unique_value_name_kingdom
    depends_on = (
        ("kingdom", "0018_auto__add_value__add_unique_value_name_kingdom"),
    )
