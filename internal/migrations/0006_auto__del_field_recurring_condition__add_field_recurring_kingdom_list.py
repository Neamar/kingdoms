...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Recurring.condition'
        db.delete_column(u'internal_recurring', 'condition')

        # Adding field 'Recurring.kingdom_list'
        db.add_column(u'internal_recurring', 'kingdom_list',
                      self.gf('config.fields.script_field.ScriptField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Recurring.condition'
        db.add_column(u'internal_recurring', 'condition',
                      self.gf('config.fields.script_field.ScriptField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Recurring.kingdom_list'
        db.delete_column(u'internal_recurring', 'kingdom_list')
    ...
    models = {
        ...
        u'internal.recurring': {
            ...
            'description': ('django.db.models.fields.TextField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'kingdom_list': ('config.fields.script_field.ScriptField', [], {'default': "''"}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '255'}),
