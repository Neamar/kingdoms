...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Avatar.sex'
        db.alter_column('internal_avatar', 'sex', self.gf('django.db.models.fields.CharField')(max_length=1))

    def backwards(self, orm):

        # Changing field 'Avatar.sex'
        db.alter_column('internal_avatar', 'sex', self.gf('django.db.models.fields.BooleanField')())
