...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Function.body'
        db.delete_column(u'internal_function', 'body')

        # Adding field 'Function.on_fire'
        db.add_column(u'internal_function', 'on_fire',
                      self.gf('config.fields.script_field.ScriptField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Function.body'
        db.add_column(u'internal_function', 'body',
                      self.gf('config.fields.script_field.ScriptField')(default='', null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Function.on_fire'
        db.delete_column(u'internal_function', 'on_fire')
