...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('internal_avatar', 'teenager')

        # Adding field 'Avatar.adult_threshold'
        db.add_column('internal_avatar', 'adult_threshold',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Avatar.teenager'
        raise RuntimeError("Cannot reverse this migration. 'Avatar.teenager' and its values cannot be restored.")
        # Deleting field 'Avatar.adult_threshold'
        db.delete_column('internal_avatar', 'adult_threshold')
