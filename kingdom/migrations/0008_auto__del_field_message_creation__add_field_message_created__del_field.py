...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('kingdom_message', 'creation', 'created')
        db.rename_column('kingdom_claim', 'creation', 'created')
        db.rename_column('kingdom_modalmessage', 'creation', 'created')


    def backwards(self, orm):
        db.rename_column('kingdom_message', 'created', 'creation')
        db.rename_column('kingdom_claim', 'created', 'creation')
        db.rename_column('kingdom_modalmessage', 'created', 'creation')
