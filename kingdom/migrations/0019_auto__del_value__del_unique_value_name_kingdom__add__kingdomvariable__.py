...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_table('kingdom_value', 'kingdom_kingdomvariable')


    def backwards(self, orm):
        db.rename_table('kingdom_kingdomvariable', 'kingdom_value')
    ...
    models = {
        ...
        'kingdom._kingdomvariable': {
            'Meta': {'unique_together': "(('name', 'kingdom'),)", 'object_name': '_KingdomVariable'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
