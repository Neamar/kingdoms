...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Folk.mentor'
        db.alter_column('kingdom_folk', 'mentor_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['kingdom.Folk']))

        # Changing field 'Folk.father'
        db.alter_column('kingdom_folk', 'father_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['kingdom.Folk']))

        # Changing field 'Folk.spouse'
        db.alter_column('kingdom_folk', 'spouse_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['kingdom.Folk']))

        # Changing field 'Folk.mother'
        db.alter_column('kingdom_folk', 'mother_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['kingdom.Folk']))

    def backwards(self, orm):

        # Changing field 'Folk.mentor'
        db.alter_column('kingdom_folk', 'mentor_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['kingdom.Folk']))

        # Changing field 'Folk.father'
        db.alter_column('kingdom_folk', 'father_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['kingdom.Folk']))

        # Changing field 'Folk.spouse'
        db.alter_column('kingdom_folk', 'spouse_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['kingdom.Folk']))

        # Changing field 'Folk.mother'
        db.alter_column('kingdom_folk', 'mother_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['kingdom.Folk']))
