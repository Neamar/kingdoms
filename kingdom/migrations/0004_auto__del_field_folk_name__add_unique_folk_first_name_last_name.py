...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Folk.name'
        db.delete_column(u'kingdom_folk', 'name')
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Folk.name'
        raise RuntimeError("Cannot reverse this migration. 'Folk.name' and its values cannot be restored.")
