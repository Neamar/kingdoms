...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Folk.birth'
        db.alter_column('kingdom_folk', 'birth', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'Folk.birth'
        db.alter_column('kingdom_folk', 'birth', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
