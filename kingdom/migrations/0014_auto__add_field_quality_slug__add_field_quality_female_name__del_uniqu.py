...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Quality', fields ['name']
        db.delete_unique(u'kingdom_quality', ['name'])

        # Adding field 'Quality.slug'
        db.add_column(u'kingdom_quality', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='slug', max_length=50),
                      keep_default=False)

        # Adding field 'Quality.female_name'
        db.add_column(u'kingdom_quality', 'female_name',
                      self.gf('django.db.models.fields.CharField')(default='female name', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Quality.slug'
        db.delete_column(u'kingdom_quality', 'slug')

        # Deleting field 'Quality.female_name'
        db.delete_column(u'kingdom_quality', 'female_name')

        # Adding unique constraint on 'Quality', fields ['name']
        db.create_unique(u'kingdom_quality', ['name'])
    ...
    models = {
        ...
        u'internal.avatar': {
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['internal.AvatarCategory']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100'})
        },
        u'internal.avatarcategory': {
