...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Folk.first_name'
        db.add_column(u'kingdom_folk', 'first_name',
                      self.gf('django.db.models.fields.CharField')(default='name', max_length=64),
                      keep_default=False)

        # Adding field 'Folk.last_name'
        db.add_column(u'kingdom_folk', 'last_name',
                      self.gf('django.db.models.fields.CharField')(default='last name', max_length=64),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Folk.first_name'
        db.delete_column(u'kingdom_folk', 'first_name')

        # Deleting field 'Folk.last_name'
        db.delete_column(u'kingdom_folk', 'last_name')
