...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Folk.kingdom'
        db.alter_column('kingdom_folk', 'kingdom_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['kingdom.Kingdom'], null=True))

    def backwards(self, orm):

        # Changing field 'Folk.kingdom'
        db.alter_column('kingdom_folk', 'kingdom_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['kingdom.Kingdom']))
