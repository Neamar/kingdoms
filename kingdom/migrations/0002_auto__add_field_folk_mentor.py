...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Folk.mentor'
        db.add_column(u'kingdom_folk', 'mentor',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['kingdom.Folk']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Folk.mentor'
        db.delete_column(u'kingdom_folk', 'mentor_id')
