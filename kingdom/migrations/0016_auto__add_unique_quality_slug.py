...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Quality', fields ['slug']
        db.create_unique(u'kingdom_quality', ['slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Quality', fields ['slug']
        db.delete_unique(u'kingdom_quality', ['slug'])
