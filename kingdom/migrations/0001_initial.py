...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'kingdom_folk', (
            ...
            ('mother', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['kingdom.Folk'])),
            ('father', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['kingdom.Folk'])),
            ('spouse', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['kingdom.Folk'])),
            ...
            ('fight', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0)),
            ('diplomacy', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0)),
            ('plot', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0)),
            ('scholarship', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0)),
            ('loyalty', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0)),
        ))
