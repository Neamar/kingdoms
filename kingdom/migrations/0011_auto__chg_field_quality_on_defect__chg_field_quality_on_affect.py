...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Quality.on_defect'
        db.alter_column('kingdom_quality', 'on_defect', self.gf('config.fields.script_field.ScriptField')(null=True))

        # Changing field 'Quality.on_affect'
        db.alter_column('kingdom_quality', 'on_affect', self.gf('config.fields.script_field.ScriptField')(null=True))

    def backwards(self, orm):

        # Changing field 'Quality.on_defect'
        db.alter_column('kingdom_quality', 'on_defect', self.gf('config.fields.script_field.ScriptField')())

        # Changing field 'Quality.on_affect'
        db.alter_column('kingdom_quality', 'on_affect', self.gf('config.fields.script_field.ScriptField')())
