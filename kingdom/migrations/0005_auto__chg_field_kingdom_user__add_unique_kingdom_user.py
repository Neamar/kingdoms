...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Kingdom.user'
        db.alter_column(u'kingdom_kingdom', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True, null=True))
        # Adding unique constraint on 'Kingdom', fields ['user']
        db.create_unique(u'kingdom_kingdom', ['user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Kingdom', fields ['user']
        db.delete_unique(u'kingdom_kingdom', ['user_id'])


        # Changing field 'Kingdom.user'
        db.alter_column(u'kingdom_kingdom', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))
