...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Quality.on_affect'
        db.add_column(u'kingdom_quality', 'on_affect',
                      self.gf('config.fields.script_field.ScriptField')(default=' ', blank=True),
                      keep_default=False)

        # Adding field 'Quality.on_defect'
        db.add_column(u'kingdom_quality', 'on_defect',
                      self.gf('config.fields.script_field.ScriptField')(default=' ', blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Quality.on_affect'
        db.delete_column(u'kingdom_quality', 'on_affect')

        # Deleting field 'Quality.on_defect'
        db.delete_column(u'kingdom_quality', 'on_defect')
