...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Quality.female_description'
        db.add_column(u'kingdom_quality', 'female_description',
                      self.gf('django.db.models.fields.TextField')(default='description f\xc3\xa9minine'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Quality.female_description'
        db.delete_column(u'kingdom_quality', 'female_description')
