...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Title.on_defect'
        db.alter_column('title_title', 'on_defect', self.gf('config.fields.script_field.ScriptField')(null=True))

        # Changing field 'Title.on_affect'
        db.alter_column('title_title', 'on_affect', self.gf('config.fields.script_field.ScriptField')(null=True))

        # Changing field 'Title.on_unlock'
        db.alter_column('title_title', 'on_unlock', self.gf('config.fields.script_field.ScriptField')(null=True))

        # Changing field 'Title.condition'
        db.alter_column('title_title', 'condition', self.gf('config.fields.script_field.ScriptField')(null=True))

    def backwards(self, orm):

        # Changing field 'Title.on_defect'
        db.alter_column('title_title', 'on_defect', self.gf('config.fields.script_field.ScriptField')())

        # Changing field 'Title.on_affect'
        db.alter_column('title_title', 'on_affect', self.gf('config.fields.script_field.ScriptField')())

        # Changing field 'Title.on_unlock'
        db.alter_column('title_title', 'on_unlock', self.gf('config.fields.script_field.ScriptField')())

        # Changing field 'Title.condition'
        db.alter_column('title_title', 'condition', self.gf('config.fields.script_field.ScriptField')())
