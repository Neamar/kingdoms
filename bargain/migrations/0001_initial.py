...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PendingBargain'
        db.create_table('bargain_pendingbargain', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('started', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('bargain', ['PendingBargain'])

        # Adding model 'PendingBargainKingdom'
        db.create_table('bargain_pendingbargainkingdom', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('pending_bargain', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bargain.PendingBargain'])),
        ...
        db.send_create_signal('bargain', ['PendingBargainKingdom'])

        # Adding model 'PendingBargainSharedMission'
        db.create_table('bargain_pendingbargainsharedmission', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('pending_bargain', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bargain.PendingBargain'])),
            ('pending_mission', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mission.PendingMission'])),
        ))
        db.send_create_signal('bargain', ['PendingBargainSharedMission'])

        # Adding model 'PendingBargainSharedMissionAffectation'
        db.create_table('bargain_pendingbargainsharedmissionaffectation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('pending_bargain_shared_mission', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bargain.PendingBargainSharedMission'])),
            ('folk', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['kingdom.Folk'])),
        ))
        db.send_create_signal('bargain', ['PendingBargainSharedMissionAffectation'])


    def backwards(self, orm):
        # Deleting model 'PendingBargain'
        db.delete_table('bargain_pendingbargain')

        # Deleting model 'PendingBargainKingdom'
        db.delete_table('bargain_pendingbargainkingdom')

        # Deleting model 'PendingBargainSharedMission'
        db.delete_table('bargain_pendingbargainsharedmission')

        # Deleting model 'PendingBargainSharedMissionAffectation'
        db.delete_table('bargain_pendingbargainsharedmissionaffectation')
    ...
    models = {
        ...
        'bargain.pendingbargainsharedmissionaffectation': {
            ...
            'folk': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['kingdom.Folk']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
