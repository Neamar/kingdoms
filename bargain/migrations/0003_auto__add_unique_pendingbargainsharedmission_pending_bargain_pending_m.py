...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'PendingBargainSharedMission', fields ['pending_bargain', 'pending_mission']
        db.create_unique('bargain_pendingbargainsharedmission', ['pending_bargain_id', 'pending_mission_id'])

        # Adding unique constraint on 'PendingBargainKingdom', fields ['kingdom', 'pending_bargain']
        db.create_unique('bargain_pendingbargainkingdom', ['kingdom_id', 'pending_bargain_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'PendingBargainKingdom', fields ['kingdom', 'pending_bargain']
        db.delete_unique('bargain_pendingbargainkingdom', ['kingdom_id', 'pending_bargain_id'])

        # Removing unique constraint on 'PendingBargainSharedMission', fields ['pending_bargain', 'pending_mission']
        db.delete_unique('bargain_pendingbargainsharedmission', ['pending_bargain_id', 'pending_mission_id'])
    ...
    models = {
        ...
        'bargain.pendingbargainkingdom': {
            'Meta': {'unique_together': "(('pending_bargain', 'kingdom'),)", 'object_name': 'PendingBargainKingdom'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'bargain.pendingbargainsharedmission': {
            'Meta': {'unique_together': "(('pending_bargain', 'pending_mission'),)", 'object_name': 'PendingBargainSharedMission'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pending_bargain': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['bargain.PendingBargain']"}),
