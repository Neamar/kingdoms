...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Mission.value_description'
        db.alter_column(u'mission_mission', 'value_description', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'Mission.value_description'
        db.alter_column(u'mission_mission', 'value_description', self.gf('django.db.models.fields.CharField')(max_length=255))
