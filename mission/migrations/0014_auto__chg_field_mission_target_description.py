...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Mission.target_description'
        db.alter_column('mission_mission', 'target_description', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'Mission.target_description'
        db.alter_column('mission_mission', 'target_description', self.gf('django.db.models.fields.CharField')(max_length=255))
