...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'MissionGrid.accept_disabled'
        db.delete_column(u'mission_missiongrid', 'accept_disabled')

        # Adding field 'MissionGrid.allow_empty'
        db.add_column(u'mission_missiongrid', 'allow_empty',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'MissionGrid.allow_disabled'
        db.add_column(u'mission_missiongrid', 'allow_disabled',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'MissionGrid.accept_disabled'
        db.add_column(u'mission_missiongrid', 'accept_disabled',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'MissionGrid.allow_empty'
        db.delete_column(u'mission_missiongrid', 'allow_empty')

        # Deleting field 'MissionGrid.allow_disabled'
        db.delete_column(u'mission_missiongrid', 'allow_disabled')
