...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'MissionGrid', fields ['slug', 'mission']
        db.create_unique(u'mission_missiongrid', ['slug', 'mission_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'MissionGrid', fields ['slug', 'mission']
        db.delete_unique(u'mission_missiongrid', ['slug', 'mission_id'])
