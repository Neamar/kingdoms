...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Mission', fields ['name']
        db.delete_unique(u'mission_mission', ['name'])

        # Deleting field 'Mission.category'
        db.delete_column(u'mission_mission', 'category')


    def backwards(self, orm):
        # Adding field 'Mission.category'
        db.add_column(u'mission_mission', 'category',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding unique constraint on 'Mission', fields ['name']
        db.create_unique(u'mission_mission', ['name'])
