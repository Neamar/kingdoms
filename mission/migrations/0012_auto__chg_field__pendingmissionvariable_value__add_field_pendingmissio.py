...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field '_PendingMissionVariable.value'
        db.alter_column('mission_pendingmissionvariable', 'value', self.gf('config.fields.stored_value.StoredValueField')(max_length=1024, null=True))
        # Adding field 'PendingMission.last_target'
        db.add_column(u'mission_pendingmission', 'last_target',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='+', null=True, to=orm['kingdom.Kingdom']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field '_PendingMissionVariable.value'
        db.alter_column('mission_pendingmissionvariable', 'value', self.gf('config.fields.stored_value.StoredValueField')(max_length=512, null=True))
        # Deleting field 'PendingMission.last_target'
        db.delete_column(u'mission_pendingmission', 'last_target_id')
