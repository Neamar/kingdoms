...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PendingMission.target'
        db.add_column(u'mission_pendingmission', 'target',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['kingdom.Kingdom']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PendingMission.target'
        db.delete_column(u'mission_pendingmission', 'target_id')
