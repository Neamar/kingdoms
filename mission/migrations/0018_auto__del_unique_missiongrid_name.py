...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'MissionGrid', fields ['name']
        db.delete_unique(u'mission_missiongrid', ['name'])


    def backwards(self, orm):
        # Adding unique constraint on 'MissionGrid', fields ['name']
        db.create_unique(u'mission_missiongrid', ['name'])
