...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Mission.cancellable'
        db.delete_column('mission_mission', 'cancellable')


    def backwards(self, orm):
        # Adding field 'Mission.cancellable'
        db.add_column('mission_mission', 'cancellable',
