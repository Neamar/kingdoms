...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model '_PendingMissionVariable'
        db.create_table('mission_pendingmissionvariable', (
        ...
        db.send_create_signal(u'mission', ['_PendingMissionVariable'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model '_PendingMissionVariable'
        db.delete_table('mission_pendingmissionvariable')
    ...
    models = {
        ...
        u'mission._pendingmissionvariable': {
            'Meta': {'unique_together': "(('mission', 'name'),)", 'object_name': '_PendingMissionVariable', 'db_table': "'mission_pendingmissionvariable'"},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
