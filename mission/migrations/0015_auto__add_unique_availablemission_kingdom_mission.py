...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'AvailableMission', fields ['kingdom', 'mission']
        db.create_unique('mission_availablemission', ['kingdom_id', 'mission_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'AvailableMission', fields ['kingdom', 'mission']
        db.delete_unique('mission_availablemission', ['kingdom_id', 'mission_id'])
