...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EventAction.condition'
        db.add_column(u'event_eventaction', 'condition',
                      self.gf('config.fields.script_field.ScriptField')(default=' ', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EventAction.condition'
        db.delete_column(u'event_eventaction', 'condition')
