...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PendingEventAction.text'
        db.alter_column(u'event_pendingeventaction', 'text', self.gf('django.db.models.fields.CharField')(max_length=512))
        # Adding unique constraint on 'PendingEvent', fields ['kingdom', 'event']
        db.create_unique(u'event_pendingevent', ['kingdom_id', 'event_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'PendingEvent', fields ['kingdom', 'event']
        db.delete_unique(u'event_pendingevent', ['kingdom_id', 'event_id'])
        ...
        # Changing field 'PendingEventAction.text'
        db.alter_column(u'event_pendingeventaction', 'text', self.gf('django.db.models.fields.CharField')(max_length=255))
