...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PendingEventToken.fallback_category'
        db.delete_column(u'event_pendingeventtoken', 'fallback_category_id')


    def backwards(self, orm):
        # Adding field 'PendingEventToken.fallback_category'
        db.add_column(u'event_pendingeventtoken', 'fallback_category',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='+', to=orm['event.EventCategory']),
                      keep_default=False)
