...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'PendingEventToken', fields ['pending_event']
        db.create_unique(u'event_pendingeventtoken', ['pending_event_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'PendingEventToken', fields ['pending_event']
        db.delete_unique(u'event_pendingeventtoken', ['pending_event_id'])
    ...
    models = {
        ...
        u'event.pendingeventtoken': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'kingdom': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['kingdom.Kingdom']"}),
            'pending_event': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['event.PendingEvent']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'started': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'null': 'True', 'blank': 'True'})
        },
        u'internal.avatar': {
