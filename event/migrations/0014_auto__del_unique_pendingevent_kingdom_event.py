...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'PendingEvent', fields ['kingdom', 'event']
        db.delete_unique('event_pendingevent', ['kingdom_id', 'event_id'])


    def backwards(self, orm):
        # Adding unique constraint on 'PendingEvent', fields ['kingdom', 'event']
        db.create_unique('event_pendingevent', ['kingdom_id', 'event_id'])
