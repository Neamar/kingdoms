...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PendingEventToken'
        db.create_table(u'event_pendingeventtoken', (
            ...
            ('pending_event', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['event.PendingEvent'], null=True, blank=True)),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['event.EventCategory'])),
            ('fallback_category', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['event.EventCategory'])),
        ))
        db.send_create_signal(u'event', ['PendingEventToken'])


    def backwards(self, orm):
        # Deleting model 'PendingEventToken'
        db.delete_table(u'event_pendingeventtoken')
    ...
    models = {
        ...
        u'event.event': {
            'Meta': {'ordering': "['slug']", 'object_name': 'Event'},
            'category': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['event.EventCategory']", 'null': 'True', 'blank': 'True'}),
        ...
        u'event.eventcategory': {
            ...
            'available_kingdoms': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['kingdom.Kingdom']", 'symmetrical': 'False', 'blank': 'True'}),
        ...
        u'event.pendingeventaction': {
            'Meta': {'unique_together': "(('pending_event', 'event_action'),)", 'object_name': 'PendingEventAction'},
        ...
        u'event.pendingeventtoken': {
            'Meta': {'object_name': 'PendingEventToken'},
            'category': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': u"orm['event.EventCategory']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'fallback_category': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': u"orm['event.EventCategory']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'kingdom': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['kingdom.Kingdom']"}),
            'pending_event': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['event.PendingEvent']", 'null': 'True', 'blank': 'True'}),
            'started': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'null': 'True', 'blank': 'True'})
        },
        u'internal.avatar': {
        ...
        u'kingdom.folk': {
            'Meta': {'ordering': "['id']", 'object_name': 'Folk'},
