...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'EventAction.name'
        db.delete_column(u'event_eventaction', 'name')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'EventAction.name'
        raise RuntimeError("Cannot reverse this migration. 'EventAction.name' and its values cannot be restored.")
