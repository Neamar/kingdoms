...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('event_pendingeventvariable', 'value', self.gf('config.fields.stored_value.StoredValueField')(max_length=4096, null=True))

    def backwards(self, orm):

        # Changing field '_PendingEventVariable.value'
        db.alter_column('event_pendingeventvariable', 'value', self.gf('config.fields.stored_value.StoredValueField')(max_length=1024, null=True))
