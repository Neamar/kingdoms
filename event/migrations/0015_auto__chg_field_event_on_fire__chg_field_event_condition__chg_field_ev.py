...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('event_event', 'on_fire', self.gf('config.fields.script_field.ScriptField')(null=True))

        # Changing field 'Event.condition'
        db.alter_column('event_event', 'condition', self.gf('config.fields.script_field.ScriptField')(null=True))

        # Changing field 'EventAction.condition'
        db.alter_column('event_eventaction', 'condition', self.gf('config.fields.script_field.ScriptField')(null=True))

    def backwards(self, orm):

        # Changing field 'Event.on_fire'
        db.alter_column('event_event', 'on_fire', self.gf('config.fields.script_field.ScriptField')())

        # Changing field 'Event.condition'
        db.alter_column('event_event', 'condition', self.gf('config.fields.script_field.ScriptField')())

        # Changing field 'EventAction.condition'
        db.alter_column('event_eventaction', 'condition', self.gf('config.fields.script_field.ScriptField')())
    ...
    models = {
        ...
        'event.eventcategory': {
            ...
            'available_kingdoms': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['kingdom.Kingdom']", 'symmetrical': 'False', 'blank': 'True'}),
        ...
        'event.pendingeventaction': {
            'Meta': {'object_name': 'PendingEventAction'},
            'event_action': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['event.EventAction']"}),
            'folk': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['kingdom.Folk']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'message': ('django.db.models.fields.TextField', [], {'default': "''", 'null': 'True', 'blank': 'True'}),
            'pending_event': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['event.PendingEvent']"}),
