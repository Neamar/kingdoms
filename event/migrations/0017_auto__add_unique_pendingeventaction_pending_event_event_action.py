...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'PendingEventAction', fields ['pending_event', 'event_action']
        db.create_unique(u'event_pendingeventaction', ['pending_event_id', 'event_action_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'PendingEventAction', fields ['pending_event', 'event_action']
        db.delete_unique(u'event_pendingeventaction', ['pending_event_id', 'event_action_id'])
